<section class="col-span-5 flex flex-col justify-center p-6">
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
        <h2 class="text-xl font-bold sm:text-2xl dark:text-white">Tanggapan Klien Kami</h2>
        ...
        <div class="mt-8 grid grid-cols-1 gap-x-16 gap-y-12 lg:grid-cols-2">
            ...
            <blockquote>
                <header class="sm:flex sm:items-center">
                    ...
                    <p class="mt-2 font-medium sm:ml-4 sm:mt-0 dark:text-white">
                        Pilihan Terbaik Kami untuk Klub Motor Terbaik di Indonesia
                    </p>
                </header>
            ...
            <blockquote>
                <header class="sm:flex sm:items-center">
                    ...
                    <p class="mt-2 font-medium sm:ml-4 sm:mt-0 dark:text-white">
                        Temukan Wahana dan Acara Motor Terbaik bersama Klub-klub Ini
                    </p>
                </header>
            ...
            <blockquote>
                <header class="sm:flex sm:items-center">
                    ...
                    <p class="mt-2 font-medium sm:ml-4 sm:mt-0 dark:text-white">
                        Bergabunglah dengan Komunitas: Klub Motor Terbaik untuk Pengendara Baru
                    </p>
                </header>
            ...
            <blockquote>
                <header class="sm:flex sm:items-center">
                    ...
                    <p class="mt-2 font-medium sm:ml-4 sm:mt-0 dark:text-white">
                        Berkendara Aman dan Bersenang-senang dengan Klub Motor Tepercaya Ini
                    </p>
                </header>
